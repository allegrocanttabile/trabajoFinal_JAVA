    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <section class="content">
            <main>
                ...
                <form class="form-inline" action="../../CreateTransporte" method="post">
                    <table>
                        <tr> 
                            <td>
                                <div class="form-group">
                                    <label for="text">Placa:</label><br>
                                    <input type="text" class="form-control"  name="txtplaca" placeholder="Ingrese su Nombre">
                                </div>
                                <br>
                            </td>
                            
                                <div class="form-group">
                                    <label for="">Año Fabricacion</label><br>
                                    <input type="date" class="form-control"  name="txtfabri" >
                                </div><br>
                        ...
                        <tr>
                               <div class="form-group">
                                    <label for="">Fecha Mantenimiento</label><br>
                                    <input type="date" class="form-control"  name="txtmante" >
                                </div><br>
                        ...
                        <tr>
                            <td>
                                ...
                                <select class="form-control" name="cbomodelo">
                           ...
                           <td>
                                ...
                                <select class="form-control" name="cbooficina">
                                   <option value="1">San Borja</option>
                                    <option value="2">San Miguel</option>
                                    <option value="3">Cerro San Cosme</option>
                                </select>
