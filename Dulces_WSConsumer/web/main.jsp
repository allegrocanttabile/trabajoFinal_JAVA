...
<html>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="main.jsp"><i class="fa fa-dashboard"></i>Inicio</a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-red">
                        ...
                        <a href="Dashboard/member.jsp" class="small-box-footer">Mas informacion <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-aqua">
                        ...
                        <a href="Dashboard/sales.jsp" class="small-box-footer">Mas informacion <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-green">
                        <div class="inner">
                            <h3>Oficinas<sup style="font-size: 20px"></sup></h3>
                            <p>Oficinas</p>
                        ...
                        <a href="Dashboard/purchase.jsp" class="small-box-footer">Mas informacion <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-blue-active">
                        ...
                        <a href="Dashboard/supplier.jsp" class="small-box-footer">Mas informacion <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
            <!-- /.row -->
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2019 <a href="#">Los Dulces</a>.</strong> Empresa Logistica
    </footer>
